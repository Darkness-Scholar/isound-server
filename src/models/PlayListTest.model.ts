...
class PlayListTest extends Model<iPlayListTest> implements iPlayListTest {
    playlist_id?: string
    playlist_name!: string
...
PlayListTest.init({
    ...
    playlist_media:{type: DataTypes.ARRAY(DataTypes.STRING), allowNull:false},
...
User.hasOne(PlayListTest,{foreignKey:'user_id'})
